...
public class Log
{
	private final static Logger log = LoggerFactory.getLogger(Log.class.getPackage().getName());
	...
	public static void info(Throwable ex,String format, Object... args)
	{
		if (log.isInfoEnabled())
		{
			log.info(String.format(format, args) + "\n" + StringUtils.exceptionStatck2String(ex));
		}
	}
